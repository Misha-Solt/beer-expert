import styles from './confirmForwardButton.module.scss'

const ConfirmForwardButton = ({
  forwardLink,
  nameForwardLink,
  onButtonClicked,
}) => {
  return (
    <div className={styles.content} data-form-type="card">
      <a href={forwardLink} onClick={onButtonClicked} className={styles.btn}>
...
export default ConfirmForwardButton
